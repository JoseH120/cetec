...
const getSolicitudes = async () => {
  ...
  try {
    api.get(url).then((respuesta) => {
      estado.solicitudes = respuesta.data;
    });
  } catch (error) {
...
<template>
  ...
  <div class="container">
    <Router-link
      v-if="!flag"
      class="btn btn-success color-with m-1"
      to="/guardar_solicitud"
    >
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody class="table-group-divider" id="contenido">
            ...
            <tr
              v-else
              v-for="(soli, i) in estado.solicitudes"
              :key="soli.IdSolicitud"
            >
              ...
              <td>
                <RouterLink
                  :to="{
                    path: '/guardar_solicitud/' + soli.IdSolicitud + '/1',
                  }"
                ...
                <RouterLink
                  :to="{
                    path: '/guardar_solicitud/' + soli.IdSolicitud + '/2',
                  }"
                ...
                <button
                  ...
                  v-on:click="eliminar(soli.NombreCurso, soli.IdSolicitud)"
                >
